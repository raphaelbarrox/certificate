...
-- VERSÃO CORRIGIDA: Remove índices com funções não IMMUTABLE
...
-- 4. ÍNDICES OTIMIZADOS SIMPLES (SEM FUNÇÕES)
-- Removido índices com DATE_TRUNC que causavam erro IMMUTABLE
...
-- Índice simples para issued_at sem função DATE_TRUNC
